...
function updateMoodBoard() {
    const positiveCount = feedbackData.filter(f => f.feedback.includes('good') ||f.feedback.includes('great') ||f.feedback.includes('helpful') || f.feedback.includes('excellent')).length;
    const negativeCount = feedbackData.filter(f => f.feedback.includes('bad') || f.feedback.includes('not + good') ||f.feedback.includes('terrible')).length;
